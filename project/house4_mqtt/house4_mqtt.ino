...
const char *client_name = "house4";

String sub_topic = "house-network/peakperiod";
const char *pub_topic = "house-network/house4-power";
...
int hourCount = 0;
int washperDay = 3; // no. of washes per day
int deferWash = 0;
int washingMachine(){
  if(washperDay > 0){
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    if(simulation>0){
      ...
      mqtt_client.publish("house-network/house-4-peakPeriod-declare", cstr);
      hourCount++;
      delay(1000);
  }
